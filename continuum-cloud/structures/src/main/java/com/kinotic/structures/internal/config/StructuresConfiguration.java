...
package com.kinotic.structures.internal.config;
...
@Configuration
@EnableElasticsearchRepositories(basePackages = "com.kinotic.structures.internal.repositories")
@ComponentScan(basePackages = "com.kinotic.structures")
