...
@Primary
@Component
public class DefaultJsonSchemaConverter extends JsonSchemaConverterComposite {

    public DefaultJsonSchemaConverter(List<JsonSchemaConverter> autowiredConverters) {
        ...
        addConverter(new PojoJsonSchemaConverter());
    }
