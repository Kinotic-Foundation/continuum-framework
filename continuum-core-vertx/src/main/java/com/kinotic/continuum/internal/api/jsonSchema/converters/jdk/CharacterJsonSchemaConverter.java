...
import com.kinotic.continuum.api.jsonSchema.StringJsonSchema;
 ...
 */
@Component
public class CharacterJsonSchemaConverter implements SpecificTypeJsonSchemaConverter {
    ...
    public JsonSchema convert(ResolvableType resolvableType,
        ...
        return new StringJsonSchema().setMinLength(0).setMaxLength(0);
    }
