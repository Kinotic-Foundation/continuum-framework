...
import com.kinotic.continuum.api.jsonSchema.DateJsonSchema;
import com.kinotic.continuum.api.jsonSchema.JsonSchema;
import com.kinotic.continuum.api.jsonSchema.datestyles.MillsDateStyle;
 ...
 */
@Component
public class DateJsonSchemaConverter implements SpecificTypeJsonSchemaConverter {
    ...
    public JsonSchema convert(ResolvableType resolvableType,
        ...
        return new DateJsonSchema().setFormat(new MillsDateStyle());
    }
}
