...
/**
 * Provides support for converting individual {@link ResolvableType}'s into the appropriate {@link JsonSchema}
 *
 *
...
public interface JsonSchemaConverter {
    ...
    /**
     * Converts the given {@link ResolvableType} to the correct {@link JsonSchema}
     *
     * @param resolvableType to convert
     * @param conversionContext for this conversion process
     * @return the newly created {@link JsonSchema} for the class
     */
