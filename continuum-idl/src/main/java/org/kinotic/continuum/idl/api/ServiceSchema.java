...
public class ServiceSchema {
     ...
     */
    private Map<String, FunctionSchema> functions = new LinkedHashMap<>();
     ...
     * @param schema {@link FunctionSchema} defining the function
     * @return this
     */
    public ServiceSchema addFunction(String name, FunctionSchema schema){
