...
@ToString
abstract class BaseComplexC3Type extends BaseC3Type implements ComplexC3Type {

    /**
     * This is the namespace of the {@link BaseComplexC3Type} such as "org.kinotic.continuum.idl.api.schema"
     */
    protected String namespace = null;

    /**
     * This is the name of the {@link BaseComplexC3Type} such as "Person", "Animal"
     */
    ...
    /**
     * The metadata keyword is legal on any {@link BaseComplexC3Type}, The objects provided must be serializable to JSON.
     ...
     */
    public BaseComplexC3Type addDecorator(C3Decorator decorator){
