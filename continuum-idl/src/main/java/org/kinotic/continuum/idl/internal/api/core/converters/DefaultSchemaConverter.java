...
@Primary
@Component
public class DefaultSchemaConverter extends SchemaConverterComposite {

    public DefaultSchemaConverter(List<SchemaConverter> autowiredConverters) {
        ...
        addConverter(new PojoSchemaConverter());
    }
