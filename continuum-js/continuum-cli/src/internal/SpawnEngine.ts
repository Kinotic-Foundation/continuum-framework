...
import {SpawnConfig, GlobalsType, PropertySchemaType} from './SpawnConfig.js'
import inquirer from 'inquirer'
import {JSONSchema7} from 'json-schema'
import {spawnResolver, SpawnResolver} from './SpawnResolver.js'
...
export default class SpawnEngine {
  ...
  constructor(spawnResolver: SpawnResolver) {
    ...
    this.engine.registerFilter('encodePackage', (v: string) => {
      v = v.replaceAll('-', "_")
      // Replaces all . followed by a number with ._number
