...
package com.kinotic.structures.api.annotations;
 ...
 * @author navid
 */
public abstract class StructuresPackages {

	private static final Logger logger = LoggerFactory.getLogger(StructuresPackages.class);

	private static final String BEAN = StructuresPackages.class.getName();
